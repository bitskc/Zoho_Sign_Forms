    ...
    <header className="bg-slate-950/80 backdrop-blur-md border-b border-white/10 px-6 py-4 sticky top-0 z-50">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <nav className="flex items-center gap-6">
          <a href="https://github.com/bitskc/Zoho_Sign_Forms" target="_blank" rel="noopener noreferrer" aria-label="View source on GitHub" className="text-slate-400 hover:text-emerald-400 transition-colors">
